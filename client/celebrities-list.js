export const CelebritiesList = [
  {
    ...
    names: ['Thor Odinson', 'Chris Hemsworth', 'Luke Hemsworth', 'Liam Hemsworth'],
    answer: 'Chris Hemsworth',
  },
  {
    url: 'https://img2.baidu.com/it/u=4077473494,910684964&fm=26&fmt=auto',
    names: ['Robert Downey Jr.', 'Jeff Bridges', 'Tony Stark', 'Robert John Downey'],
  ...
  },
  {
    ...
    names: ['Mark Alan Ruffalo', 'Eric Bana', 'Tony Stark', 'Robert Bruce Banner'],
    answer: 'Mark Alan Ruffalo',
  },
  {
    url: 'https://img2.baidu.com/it/u=744724782,205696845&fm=26&fmt=auto',
    names: ['Christian Bale', 'Josh James Brolin', 'Aaron Eckhart', 'Robert John Downey'],
    answer: 'Josh James Brolin',
  },
  {
    url: 'https://img1.baidu.com/it/u=2110223230,3202604494&fm=26&fmt=auto',
    names: ['Elizabeth Olsen', 'Wanda Django Maximoff', 'Mary-Kate Olsen', 'Ashley Olsen'],
    answer: 'Elizabeth Olsen',
  },
  {
    url: 'https://img1.baidu.com/it/u=1793835732,449516069&fm=26&fmt=auto',
    names: ['Pietro Django Maximoff', 'Jeff Bridges', 'Aaron Taylor-Johnson', 'Ezra Miller'],
